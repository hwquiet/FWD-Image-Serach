...
# -*- coding: utf-8 -*-
"""
FWD Image Search — 主应用程序
缩略图网格 + 侧边栏文件夹树 + 预览面板 + 搜索过滤
"""
...
from config import (
    ...
    _get_config_path,
    is_image_file,
    get_image_files_and_struct,
)

# 拖拽上传支持（与 config 中的 _DND_AVAILABLE 保持同步）
try:
...
class ImageViewerApp:
    ...
    def _render_thumbnails(self, folder_filter: str | None = None):
        ...
        visible_rows = viewport_h // (self.CARD_HEIGHT + self.CARD_PAD) + 3
